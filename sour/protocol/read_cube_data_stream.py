...
class ReadCubeDataStream(object):
    def __init__(self, data="", pos=0):
        try:
            if isinstance(data, ReadCubeDataStream):
                ...
                print(
                    "I don't know what I got so just trying to map to a bytearray using ord. This shouldn't happen, it is slow."
                )
    ...
    def getstring(self, peek=False):
        try:
            ...
            if not peek:
                self.getbyte(peek)  # Throw away the null terminator
