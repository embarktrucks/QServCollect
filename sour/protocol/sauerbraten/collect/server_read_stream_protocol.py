...
mt = MessageType("N_EDITMODE", Field(name="value", type="int"))
sauerbraten_stream_spec.add_message_type(message_types.N_EDITMODE, mt)

mt = MessageType("N_PING", Field(name="cmillis", type="int"))
...
mt = MessageType("N_GUNSELECT", Field(name="gunselect", type="int"))
...
mt = MessageType("N_CLIENTPING", Field(name="ping", type="int"))
...
mt = MessageType(
    "N_MAPCRC", Field(name="map_name", type="string"), Field(name="mapcrc", type="int")
)
...
mt = MessageType(
    "N_TAKEFLAG", Field(name="flag", type="int"), Field(name="version", type="int")
)
...
mt = MessageType("N_MASTERMODE", Field(name="mastermode", type="int"))
sauerbraten_stream_spec.add_message_type(message_types.N_MASTERMODE, mt)

mt = MessageType(
    "N_KICK", Field(name="target_cn", type="int"), Field(name="reason", type="string")
)
...
mt = MessageType(
    "N_SPECTATOR", Field(name="target_cn", type="int"), Field(name="value", type="int")
)
sauerbraten_stream_spec.add_message_type(message_types.N_SPECTATOR, mt)

mt = MessageType(
    "N_SETTEAM", Field(name="target_cn", type="int"), Field(name="team", type="string")
)
sauerbraten_stream_spec.add_message_type(message_types.N_SETTEAM, mt)

mt = MessageType("N_RECORDDEMO", Field(name="value", type="int"))
sauerbraten_stream_spec.add_message_type(message_types.N_RECORDDEMO, mt)

mt = MessageType("N_CLEARDEMOS", Field(name="demonum", type="int"))
...
mt = MessageType("N_GETDEMO", Field(name="demonum", type="int"))
...
mt = MessageType("N_FORCEINTERMISSION", Field(name="size", type="int"))
sauerbraten_stream_spec.add_message_type(message_types.N_FORCEINTERMISSION, mt)

mt = MessageType("N_NEWMAP", Field(name="size", type="int"))
...
mt = MessageType("N_ADDBOT", Field(name="skill", type="int"))
...
mt = MessageType(
    ...
    IteratedFieldCollection(
        name="data", count=Field(type="int"), field_collection=RawField(size=1)
    ),
)
sauerbraten_stream_spec.add_message_type(message_types.N_CLIPBOARD, mt)

common_edit_fields = [
    Field(name="sel_ox", type="int"),
...
mt = MessageType("N_ROTATE", *(common_edit_fields + [Field(name="axis", type="int")]))
...
mt = MessageType(
    ...
    IteratedFieldCollection(name="attrs", count=5, field_collection=Field(type="int")),
)
...
mt = MessageType(
    ...
    SwitchField(
        ...
        cases=[
            CaseField(
                predicate_comparison=lambda t: t == cs_id_types.ID_VAR,
            ...
            CaseField(
                predicate_comparison=lambda t: t == cs_id_types.ID_FVAR,
                consequent=FieldCollection(
                    Field(name="var_type", type="int"),
                    Field(name="var_name", type="string"),
            ...
            CaseField(
                predicate_comparison=lambda t: t == cs_id_types.ID_SVAR,
                consequent=FieldCollection(
                    Field(name="var_type", type="int"),
                    Field(name="var_name", type="string"),
        ...
        default=FieldCollection(
            Field(name="var_type", type="int"), Field(name="var_name", type="string")
        ),
        peek_predicate=True,
    ),
)
