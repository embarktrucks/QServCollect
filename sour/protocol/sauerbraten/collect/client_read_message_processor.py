...
from sour.common.constants import message_types
...
from sour.protocol.sauerbraten.collect.client_read_stream_protocol import (
    sauerbraten_stream_spec,
)
from sour.protocol.sauerbraten.collect.read_physics_state import read_physics_state
...
class ClientReadMessageProcessor(object):
    ...
    def _parse_channel_0_data(self, data):
        ...
        if message_type == message_types.N_POS:
            ...
            message = (
                "N_POS",
                {"clientnum": cn, "physics_state": physics_state, "raw_position": data},
            )
            ...
            message = (
                "N_TELEPORT",
                {"aiclientnum": cn, "teleport": teleport, "teledest": teledest},
            )
