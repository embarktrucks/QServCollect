...
mt = MessageType("N_TIMEUP", Field(name="value", type="int"))
sauerbraten_stream_spec.add_message_type(message_types.N_TIMEUP, mt)

mt = MessageType("N_ANNOUNCE", Field(name="type", type="int"))
...
mt = MessageType(
    ...
    TerminatedFieldCollection(
        ...
        field_collection=FieldCollection(
            Field(name="clientnum", type="int"), Field(name="privilege", type="int")
        ),
    ),
)
...
mt = MessageType(
    ...
    TerminatedFieldCollection(
        ...
        field_collection=FieldCollection(
            Field(name="team", type="string"), Field(name="frags", type="int")
        ),
    ),
)
        ...
        field_collection=FieldCollection(
            ...
            ConditionalFieldCollection(
                ...
                alternative=FieldCollection(
                    Field(name="owner", type="int"), Field(name="invisible", type="int")
                ),
                peek_predicate=True,
            ),
        ),
...
mt = MessageType(
    "N_INVISFLAG", Field(name="flag", type="int"), Field(name="invisible", type="int")
)
...
mt = MessageType(
    "N_REPAMMO", Field(name="clientnum", type="int"), Field(name="ammotype", type="int")
)
...
mt = MessageType(
    ...
    TerminatedFieldCollection(
        ...
        terminator_comparison=lambda t: t >= 0,
        field_collection=FieldCollection(
            Field(name="clientnum", type="int"), Field(name="count", type="int")
        ),
    ),
)
...
mt = MessageType("N_ITEMSPAWN", Field(name="item_index", type="int"))
...
mt = MessageType("N_ROTATE", *(common_edit_fields + [Field(name="dir", type="int")]))
...
mt = MessageType("N_FORCEDEATH", Field(name="clientnum", type="int"))
...
mt = MessageType("N_REQAUTH", Field(name="domain", type="string"))
...
mt = MessageType("N_SWITCHMODEL", Field(name="model", type="int"))
