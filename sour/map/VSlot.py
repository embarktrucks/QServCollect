...
"""
from sour.common.constants import shader_param_types, vslot_types
from sour.common.vec import vec
from sour.map.ShaderParam import ShaderParam
from sour.map.utils import readushort, readfloat, readint
import struct
