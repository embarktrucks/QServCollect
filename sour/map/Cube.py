...
"""
from sour.map.threeplanesintersect import threeplaneintersect
import struct
from sour.map.Plane import Plane
...
from sour.map.dimension import dimension, dimcoord
...
class Cube(object):
    ...
    def isentirelysolid(self):
        return (
            self.faces[0] == F_SOLID
            and self.faces[1] == F_SOLID
            and self.faces[2] == F_SOLID
        )
