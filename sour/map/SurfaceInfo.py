...
"""
from sour.common.constants import layer_types
from sour.map.utils import readuchar
import struct
...
class SurfaceInfo(object):
    ...
    def __eq__(self, o):
        return (
            self.lmid[0] == o.lmid[0]
            and self.lmid[1] == o.lmid[1]
            and self.verts == o.verts
            and self.numverts == o.numverts
        )
