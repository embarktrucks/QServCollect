...
"""
from sour.common.constants import material_types


def convertoldmaterial(mat):
    return (
        ((mat & 7) << material_types.MATF_VOLUME_SHIFT)
        | (((mat >> 3) & 3) << material_types.MATF_CLIP_SHIFT)
        | (((mat >> 5) & 7) << material_types.MATF_FLAG_SHIFT)
    )
