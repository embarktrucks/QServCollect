...
"""
from sour.crypto.gfield import GField
import cube2crypto.ecc_params as ecc_params
import cube2crypto.tiger as tiger
from sour.crypto.jacobian import Jacobian
from sour.crypto.get_random_number import get_random_number
...
if __name__ == "__main__":
    authkeys = [
        {
            "private": "f373de2d49584e7a16166e76b1bb925f24f0130c63ac9332",
    ...
    class TestCube2Crypto(unittest.TestCase):
        def test_public_key_recovery(self):
            for authkey in authkeys:
                self.assertEqual(
                    authkey["public"], str(get_public_key(authkey["private"]))
                )
